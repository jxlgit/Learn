...
public class Bak_KDTree {
     ...
     * @return KDTree树
     */
    public static Bak_KDTree build(double[][] input){
        int n = input.length;
        ...
        Bak_KDTree tree = new Bak_KDTree();
    ...
    public static void correct() {
        ...
        while(count-- > 0){
            ...
            Bak_KDTree tree=Bak_KDTree.build(input);
    ...
    /**
     *  测试
     * @param testDatasize 测试数据
     * @param modelDatasize 训练数据
     */
    public static void test(int testDatasize,int modelDatasize){
        
    	// 构建训练数据
        double[][] input = new double[modelDatasize][5];
        for(int i=0;i<modelDatasize;i++){
            input[i][0]=Math.random()*modelDatasize;
            input[i][1]=Math.random()*modelDatasize;
            input[i][2]=Math.random()*modelDatasize;
            input[i][3]=Math.random()*modelDatasize;
            input[i][4]=Math.random()*modelDatasize;
        }
        Bak_KDTree tree = Bak_KDTree.build(input);
        ...
        System.out.println("modelDatasize:"+modelDatasize+";testDatasize:"+testDatasize);
        System.out.println("kdtree搜索耗时:"+timekdtree);
        System.out.println("linear搜索耗时:"+timelinear);
    }
